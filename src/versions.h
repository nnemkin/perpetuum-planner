...
#define VER_LEGALCOPYRIGHT_STR "Copyright (c) 2010, 2011, 2012, 2014 Nikita Nemkin"
#define VER_PRODUCTVERSION 1,2,8,0
#define VER_PRODUCTVERSION_STR "1.2.8"
#define VER_PRODUCTVERSION_DATE "2014-01-12"
#define VER_PROGID "PerpetuumPlanner.Agent"

#define VER_FILEVERSION 1,2,8,0
#define VER_FILEVERSION_STR "1.2.8"
